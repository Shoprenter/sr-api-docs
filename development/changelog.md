...
#### 2023.09.05
Egyszerűbbé tettük a szülő-gyerek termékkapcsolatok lekérését és kezelését a Shoprenter API-ban. A Product Resourceban lehetővé vált egy filterezés. A `parentProductId`-t paraméterként megadva a szűrésben, visszakapjuk az azonos `parentProductId`-val rendelkező termékeket.
