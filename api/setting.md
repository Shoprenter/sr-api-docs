...
<ResourceProperties :resource="'setting'" :lang="'hu'"/>

## Setting kulcsok jelentései
...
[//]: <> (GET ENDPOINT)
<ResourceEndpoint :resource="'setting'" :endpoint="'get'" :lang="'hu'">
...
<ResourceEndpoint :resource="'setting'" :endpoint="'getCollection'" :lang="'hu'">
